...
class PkgrepoTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test_keyserver_and_key_url_should_be_mutually_exclusive_in_managed(self):
        ...

    def test_keyserver_and_key_text_should_be_mutually_exclusive_in_managed(self):
        ...

    def test_url_and_key_text_should_be_mutually_exclusive_in_managed(self):
        ...

    def test_managed_with_new_key_in_keyserver_should_return_changes(self):
        ...

    def test_managed_with_new_key_in_key_url_should_return_changes(self):
        ...

    def test_managed_with_new_key_in_key_text_should_return_changes(self):
        ...
